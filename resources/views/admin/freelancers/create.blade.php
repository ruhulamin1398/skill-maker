                    ...
                    <div class="card-inner">
                        <form action="{{ route('freelancers.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="language" placeholder="Enter Language"  class="form-control" value="{{ old('language') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="skills" placeholder="Enter Skills"  class="form-control" value="{{ old('skills') }}">
