                    ...
                    <div class="card-inner">
                        <form action="{{ route('faq.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="question" placeholder="Enter question"  class="form-control" value="{{ old('question') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="answere" placeholder="Enter Address"  class="form-control" value="{{ old('answere') }}">
