                    ...
                    <div class="card-inner">
                        <form action="{{ route('supports.update', $support->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" placeholder="Enter Service Title"  class="form-control" value="{{ $support->title }}">
                                @if($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" placeholder="Enter Email"  class="form-control" value="{{ $support->email }}">
                                @if($errors->has('email'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" placeholder="Enter Email"  class="form-control" value="{{ $support->phone }}">
                                @if($errors->has('phone'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="facebook" placeholder="Enter Facebook Address"  class="form-control" value="{{ $support->facebook }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="summernote-basic">{{ $support->description }}</textarea>
