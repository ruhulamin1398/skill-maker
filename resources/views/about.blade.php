    ...
    <div class="row justify-content-center align-items-center">
      <div class="col-md-4">
        <div class="icon-box icon-box1">
          ...
          <h4>Our Vission</h4>
          <p>Our vision is to Coach, Teach and Building Skills to be an Expert who can show his Competency and ready to compete with Global Digital Market.</p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="icon-box icon-box2">
          ...
          <h4>Our Mission</h4>
          <p>Our mission is to take part in Digital Revolution and the Economic Growth of Bangladesh by establishing a Skilled Workforce who will Compete Global e-Commerce Marketplace and attain Financial Freedom.</p>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="icon-box icon-box3">
          {{-- <i class="icofont-chart-bar-graph"></i> --}}
          <h4>Our Values</h4>
          <p>We are here for Empowering Societies in Digital means.</p>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="icon-box icon-box3">
          ...
          <p>We aim to Create 2 Million employment Opportunities in Bangladesh by 2024. We'll continue to explore, define and refine our targeted audiences goals and tasks as they will get more comfortable with their career growth.</p>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="icon-box icon-box6">
          {{-- <i class="icofont-chart-bar-graph"></i> --}}
          <h4>How we engage ourselves </h4>
          <p>Our Society is changing rapidly with the pace of the world’s dynamic behavior. Thanks to our Government, People’s Republic of Bangladesh and its ICT Division who takes the mission of Digital Bangladesh with utmost care and transforming the country widely into the digital platform.</p>
        </div>
      </div>
...
<section id="aboutValues">
  <div class="container text-light">
    ...
    <div class="row">
      <div class="col">
        <div class="content">
          <p>The ambassadors of the Skillmaker are strongly associated with US, UK, EU and other parts of the world particularly in the e-commerce sector, which creates opportunities for our learners to learn some targeted skillset with practical exposure and develop themselves for abundant of scope to compete globally. Here, our unique skillset will be the key to the learners to become successful e-earners to remain competitive..</p>
